...
export default function SupplyInvoicePage() {
    ...
    useEffect(() => {
        const savedOrder = sessionStorage.getItem('don_maris_supply_invoice');
        if (savedOrder) {
            setOrder(JSON.parse(savedOrder));
        } else {
            router.push('/admin/supply-department');
        }
    }, [router]);
    ...
    return (
        <div className="container mx-auto px-4 py-8">
           <h1 className="text-4xl font-bold font-headline mb-8 text-center">Supply Invoice Preview</h1>
                ...
                <div className="relative z-10">
                    ...
                    <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
                        <Button asChild variant="outline">
                            <Link href="/admin/supply-department">
