    ...
    return (
      <Link
        ...
        className={cn(
          ...
          isMobile && "justify-start text-lg py-5 px-3"
        )}
          ...
          <div className="flex items-center gap-2 sm:gap-4 shrink-0">
                    ...
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end" className="w-56">
                        <DropdownMenuLabel>
                          <Link
                            href="/profile"
                            className="block p-1 rounded-md hover:bg-muted"
                          >
            ...
            <div className="md:hidden">
              <Sheet open={isSheetOpen} onOpenChange={setSheetOpen}>
                ...
                <SheetContent side="right" className="w-[85%] max-w-[330px]">
                  <SheetHeader>
                    <SheetTitle className="sr-only">Navigation</SheetTitle>
                  </SheetHeader>

                  <nav className="flex flex-col gap-4 mt-10 w-full">
                    {visibleNavLinks.map((link) => (
